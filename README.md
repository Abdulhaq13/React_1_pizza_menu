Pizza Menu 🍕
A simple React application that displays a pizza restaurant menu. This project was built while learning React fundamentals such as components, props, and conditional rendering.
